...
/**
 * S3a2c — "What does that even mean?"
 * Auto-cycles through phrases. User hits next/space to advance slide.
 */
    ...
    <div className="flex-1 flex flex-col px-12 py-10 animate-fade-in overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center min-h-0">
        ...
        <h1
          ...
          style={{ fontSize: "clamp(8rem, 16cqw, 22rem)", letterSpacing: "-0.05em" }}
        >
